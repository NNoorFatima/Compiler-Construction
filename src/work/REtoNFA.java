...
//                if (wordNFA == null) {
//                    wordNFA = NFA.createSimpleNFA(c,"Keywords");
//                } else {
//                    wordNFA = NFA.concatenate(wordNFA, NFA.createSimpleNFA(c,"Keywords"));
//                }
//            }
//            if (result == null) {
//                result = wordNFA;
...
//        NFA firstLetter = NFA.createSimpleNFA('a',"Keywords");  // Matches lowercase 'a', adjust for the full range [a-z]
//        NFA repeat = NFA.kleeneStar(NFA.createSimpleNFA('a',"Keywords"));  // Matches any lowercase letter a-z
...
//        NFA integerPart = NFA.createSimpleNFA('0',"Keywords"); // Matches the leading 0 (or you could add more logic for [1-9])
//        NFA decimalPart = NFA.createSimpleNFA('.',"Keywords"); // Matches decimal part
//        NFA exponentPart = NFA.createSimpleNFA('e',"Keywords");  // Matches scientific notation part
//        
...
//        NFA modulo = NFA.createSimpleNFA('%',"Operator");
//        NFA equals = NFA.createSimpleNFA('=',"Operator");
//
